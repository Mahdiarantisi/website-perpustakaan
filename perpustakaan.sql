...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Bulan Mei 2025 pada 03.15
...
INSERT INTO `books` (`id`, `judul`, `penulis`, `tahun_terbit`, `stok`) VALUES
(1, 'agama', NULL, NULL, NULL);
...
INSERT INTO `loans` (`id`, `user_id`, `book_id`, `tanggal_pinjam`, `tanggal_kembali`, `status`) VALUES
(1, 1, 1, '2025-05-22', '2025-06-22', 'Dipinjam');
...
INSERT INTO `users` (`id`, `nama`, `kelas`, `nis`) VALUES
(1, 'mahdi', NULL, NULL);
